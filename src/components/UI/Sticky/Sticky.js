 ...
 * children-accessible It was specifically built for the rich text
...
export class StickyContext extends Component {
  ...
  static propTypes = {
    ...
    /**
     * registerListener: accepts a function that is called with `requestStickyUpdate` as an arg, so
     * it can be accessed from the component implementation site similar to how refs are accessed:
     *
